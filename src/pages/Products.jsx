    ...
    <>
      <div className=" container mx-auto mt-10">
        <div className="flex justify-between py-5 items-center1">
          <h1 className="text-2xl font-bold mb-3">All Products <span className="text-sm text-gray-400 font-normal">({products.length}) products Found</span> </h1>
